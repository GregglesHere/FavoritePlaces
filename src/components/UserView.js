            ...
            <Box sx = {rootBox}>
                    ...
                    <Box sx ={{...modal, width:400, height: 400}}>
                        <Grid container>
                                <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}} >
                                    <Typography>Remember to mark location on map</Typography>
                                </Grid>
                                <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}} >
                                ...
                                <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}} >
                                    <Typography>Choose image to display</Typography>
                                </Grid>
                                <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}}>
                                ...
                                <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}}>
                                    <Button sx = {{borderRadius: 8}} variant= "contained" onClick={handleCloseAddPlace}>Cancel</Button>  
                                </Grid>
                        </Grid>
                    </Box>
                </Modal>
                <Modal sx = {{backdropFilter: "blur(1px)"}} hideBackdrop open = {openPic} >
                    <Box sx ={{...modal, width:300, height: 200}}>
                        <Grid container>
                                ...
                                <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}}>
                                    <Button onClick = {handleSaveEditProfilePic} sx = {{borderRadius: 8}} variant= "contained" >Save</Button>
                                </Grid>
                                <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}}>
                                    <Button sx = {{borderRadius: 8}} variant= "contained" onClick={handleCloseEditProfilePic}>Cancel</Button>  
                                </Grid>
                        </Grid>
                    </Box>
                </Modal>
                <Modal sx= {{backdropFilter: "blur(1px)"}} hideBackdrop open={open} >
                    <Box sx={{ ...modal, width: 500 }}>
                        <Grid container>
                            ...
                            <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}}>
                                <Button onClick = {handleSaveEdit} sx = {{borderRadius: 8}} variant= "contained" >Save</Button>
                            </Grid>
                            <Grid item xs = {12} sx = {{display: "flex", justifyContent: "center", my: '10px'}}>
                                <Button sx = {{borderRadius: 8}} variant= "contained" onClick={handleClose}>Cancel</Button>  
                            </Grid>
                        </Grid>
                    </Box>
                </Modal>
                <Grid container>
                    ...
                    <Grid item xs = {4} sx = {{height: "80%"}}>
                            ...
                            <List sx={{ width: '100%',position: 'relative',overflow: 'auto',maxHeight: "90%",}}>    
                                {places.map((place,index) => (
                                    <ListItem key ={place._id} >
                                        <Card sx = {{ display: "flex", justifyContent: "center",width: "100%" ,height:"400px"}}>
                                            <CardContent sx = {{width: "80%", height: "70%"}}>
                                                ...
                                                <Typography sx = {{fontWeight: 'bold', textAlign: "center"}} >{place.name}</Typography>
                                                <Typography sx = {{textAlign: "center"}}>{place.description}</Typography>
                                            </CardContent>
                                        </Card>
                                    </ListItem>
                                ))}
                    ...
                    <Grid item xs = {8} sx = {mapGridItem} >
                        <Box sx = {mapBox}>
                            {isUser &&    <Typography sx = {{textAlign: "center"}}>Move red marker to location before clicking "ADD PLACE"</Typography>}
                            <Map mapLib={mapboxgl} 
                                initialViewState={{
